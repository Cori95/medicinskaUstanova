...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('lastname', trans('quickadmin.users.fields.lastname').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('brithdate', trans('quickadmin.users.fields.brithdate').'*', ['class' => 'control-label']) !!}
                    {!! Form::text('brithdate', old('brithdate'), ['class' => 'form-control date', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
